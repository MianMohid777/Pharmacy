...
public class WeeklyReport extends Report implements SalesReport {
    ...
    public void createSalesReport() throws IOException {
        ...
        String file = "/Users/FullStackMohid/IdeaProjects/PharamacyPos/Sales Report/Weekly_Sales_Report_( " + super.getStart() + " - " + super.getEnd() + " ).xlsx";

        Workbook workbook = new XSSFWorkbook();
        Sheet sheet = workbook.createSheet("WeeklySalesReport");
