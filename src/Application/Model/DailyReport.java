...
public class DailyReport extends Report implements SalesReport {
    ...
    public void createSalesReport() throws IOException {
        ...
        String file = "/Users/FullStackMohid/IdeaProjects/PharamacyPos/Sales Report/Daily_Sales_Report_( " + super.getStart() + " - " + super.getEnd() + " ).xlsx";

        Workbook workbook = new XSSFWorkbook();
        Sheet sheet = workbook.createSheet("DailySalesReport");
